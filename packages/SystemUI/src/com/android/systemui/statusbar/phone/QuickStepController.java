...
import com.android.internal.util.astro.AstroUtils;
...
public class QuickStepController implements GestureHelper {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mNavigationBarView.isDt2s() && isDoubleTapPending) {
                    ...
                    if (isDoubleTapReally) AstroUtils.switchScreenOff(mContext);
                } else {
            ...
            case MotionEvent.ACTION_UP:
               if (mNavigationBarView.isFullGestureMode()) {
                    ...
                    if (mBackActionScheduled) {
                        AstroUtils.sendKeycode(KeyEvent.KEYCODE_BACK, mHandler);
    ...
    private Runnable mDoubleTapCancelTimeout = new Runnable() {
        ...
        public void run() {
            ...
            mHandler.removeCallbacksAndMessages(null);
            AstroUtils.sendKeycode(KeyEvent.KEYCODE_HOME, mHandler);
        }
    };
    ...
    private void moveKbCursor(boolean right, boolean firstTrigger) {
        ...
        AstroUtils.moveKbCursor(KeyEvent.ACTION_UP, right);
        AstroUtils.moveKbCursor(KeyEvent.ACTION_DOWN, right);
